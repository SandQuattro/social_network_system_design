...
Фактор репликации: 3 (2 Multi-Master, 1 slave)

Количество хостов без репликации: 16 дисков / 2 диска, подключенных к 1 хосту ~ 8
Количество хостов с учетом репликации: 8 хостов без репликации * фактор репликации 3 = 24

Итого: примерное количество хостов для хранения и обработки данных с учетом репликации - 24
...
- Дисков на хост также 2, 16 / 2 = 8 хостов без репликации * фактор репликации 3 = 24

Итого: Количество хостов не изменится, останется = 24, так как новый фактор репликации компенсирует доп требования на хранение
и обработку медиа